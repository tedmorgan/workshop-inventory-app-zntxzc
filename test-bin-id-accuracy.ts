...
const TEST_QUERIES = [
  ...
  'What do I have for painting?',
  'I need to sand something smooth',
  'What tools work with masonry?',
  'What can I use to measure things?',
  'Tools for electrical work',
  'What do I have for cutting metal?',
  'I need to fasten things together',
  'What tools help with leveling?',
  'What can I use for mixing?',
  'Tools for tile work',
  'What do I have for grinding?',
  'I need to remove screws',
  'What tools work with pipes?',
  'What can I use to shape wood?',
  'Tools for concrete work',
  'What do I have for finishing surfaces?',
  'I need to make holes',
  'What tools help with assembly?',
  'What can I use for demolition?',
  'Tools for finishing work',
  'What do I have for cutting?',
  'I need to smooth surfaces',
  'What tools work with fasteners?',
  'What can I use to measure angles?',
  'Tools for repair work',
  'What do I have for construction?',
];
